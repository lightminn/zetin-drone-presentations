...
개념 영상은 28·29·30·34·35·43·45·48·62번에 있고, 실제 테더 시험 영상은
69번과 마지막 77번에 있다. 모든 영상은 활성 슬라이드에서 음소거 상태로 자동재생·반복되며, 다른
...
현재 체크인된 PPTX와 PDF는 HTML 기준본과 같은 77장 산출물이다. PPTX와 PDF는
...
개별 편집할 수는 없다. 11개 영상은 파일 안에 포함되며 데스크톱 PowerPoint에서
