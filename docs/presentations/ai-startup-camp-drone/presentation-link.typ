#let deck-url = "https://lightminn.github.io/zetin-drone-presentations/"
#let ink = rgb("#172033")
...
#align(center + horizon)[
  #block(width: 820pt)[
    #align(center)[
      ...
      #text(size: 38pt, weight: 750)[자작 드론 기술 발표]

      #v(8pt)

      #text(size: 22pt, weight: 500, fill: muted)[발표자료 링크]
      ...
      #link(deck-url)[
        #box(
          ...
          #align(center)[
            #text(size: 20pt, weight: 700, fill: white)[발표자료 열기 ↗]
          ]
        ]
      ]
