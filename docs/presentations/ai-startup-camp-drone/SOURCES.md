...
| 30, 38, 52, 54 | 믹서 포화, 가속도계 신뢰도, 제어 주기, 중력과 Yaw의 관계를 설명하는 개념 영상 | 팀원 제공 원본 영상, 발표용으로 정규화한 [`mixer-saturation.mp4`](assets/mixer-saturation.mp4), [`accelerometer-confidence.mp4`](assets/accelerometer-confidence.mp4), [`cascade-loop-response.mp4`](assets/cascade-loop-response.mp4), [`gravity-yaw-observability.mp4`](assets/gravity-yaw-observability.mp4) | 설명용 시뮬레이션. 실기·SIL 측정값이나 비행 검증 증거가 아님 |
